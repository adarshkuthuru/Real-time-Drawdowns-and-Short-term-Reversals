...
snp=read.csv(file.choose(),header = T) #sp500mini file from 
...
DD_strategy=read.csv('E:/Drive/Realtime_DD_iteration1/DD_repeated_thrice/DD_strategy.csv',header =T)
ADD_strategy=read.csv('E:/Drive/Realtime_DD_iteration1/DD_repeated_thrice/ADD_strategy.csv',header =T)
